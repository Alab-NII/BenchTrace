#!/usr/bin/env python3
"""
ScienceWorld Evolution Evaluation runner — AutoSkill baseline
...
SKILL_EXTRACTION_SYSTEM = (
    "You are an expert analyst of science experiment playthroughs in a text-based environment. "
...
Final progress: {final_score:.2f} (1.0 = experiment completed)
...
description: [1 sentence: what science experiment situation this skill applies to]
