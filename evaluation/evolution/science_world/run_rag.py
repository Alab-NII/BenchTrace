#!/usr/bin/env python3
"""
ScienceWorld Evolution Evaluation runner — RAG baseline
...
SYNTHESIS_SYSTEM_PROMPT = (
    "You are an expert analyst of science experiment episodes. "
    "Given relevant past observations and actions, extract concise actionable insights."
)

SYNTHESIS_PROMPT_TEMPLATE = """\
The following are relevant steps retrieved from past science experiment episodes.
