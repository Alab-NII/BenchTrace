#!/usr/bin/env python3
"""
BabyAI Evolution Evaluation runner — MemRL baseline
...
BabyAI differences from AlfWorld:
  ...
  - q_value = final_score directly (already 0-1 progress, no GAME_MAX_SCORE needed)
...
SCRIPT_SYSTEM_PROMPT = (
    "You are an expert analyst of navigation and manipulation task trajectories "
