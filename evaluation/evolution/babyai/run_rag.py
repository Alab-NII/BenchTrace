#!/usr/bin/env python3
"""
BabyAI Evolution Evaluation runner — RAG baseline
...
SYNTHESIS_SYSTEM_PROMPT = (
    "You are an expert analyst of navigation and manipulation task episodes in a grid-based "
    "environment. Given relevant past observations and actions, extract concise actionable insights."
)

SYNTHESIS_PROMPT_TEMPLATE = """\
The following are relevant steps retrieved from past grid navigation task episodes.
