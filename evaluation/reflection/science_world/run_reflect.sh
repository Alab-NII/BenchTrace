#!/bin/bash
# run_reflect.sh — Start VLLM server, run AlfWorld Reflection Task, then auto-shutdown.
#
# Usage:
#   bash run_reflect.sh [MODEL] [GAMES]
#
# Defaults: MODEL=qwen3-32b, GAMES=all (all 6 AlfWorld task families)

set -euo pipefail

WORKDIR="/home/jiahao_huang/ROGUE/ScienceWorld/reflect"
...
PORT=8001
GPUS="4,5"
VLLM_SESSION="vllm_reflect_scienceworld"
...
log "============================================"
log " run_reflect.sh (ScienceWorld)  MODEL=$MODEL  GAMES=$GAMES"
log "============================================"
