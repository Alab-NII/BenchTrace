#!/bin/bash
# run_reflect.sh — Start VLLM server, run Reflection Task, then auto-shutdown
#
# Usage:
#   bash run_reflect.sh [MODEL] [GAMES]
#
# Defaults: MODEL=qwen3-32b, GAMES=all

set -euo pipefail

WORKDIR="/home/jiahao_huang/ROGUE/JTTL/reflect"
...
log "============================================"
log " run_reflect.sh  MODEL=$MODEL  GAMES=$GAMES"
log "============================================"
