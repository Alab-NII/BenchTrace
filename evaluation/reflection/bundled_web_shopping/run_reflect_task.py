...
Runs the Reflection Task evaluation for a given model on BundledWebShopping snapshots.
...
ALL_GAMES = ["baking", "beauty", "electronics", "grocery", "home"]
...
def run(args):
    ...
    system_prompt = load_prompt("system_bundled_web_shopping.md")
