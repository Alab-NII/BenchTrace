#!/bin/bash
# run_reflect.sh — Start VLLM server, run GTP Reflection Task, then auto-shutdown.
#
# Usage:
#   bash run_reflect.sh [MODEL] [GAMES]
#
# Defaults: MODEL=qwen3-32b, GAMES=all (all 4 GTP traveler-count categories)

set -euo pipefail

WORKDIR="/home/jiahao_huang/ROGUE/GroupTravelPlanning/reflect"
...
log "============================================"
log " run_reflect.sh (GTP)  MODEL=$MODEL  GAMES=$GAMES"
log "============================================"
