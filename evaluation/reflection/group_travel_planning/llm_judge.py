...
LLM-as-judge for Q3 (Diagnosis) on GroupTravelPlanning snapshots.
...
SYSTEM_PROMPT = """You are evaluating whether a model's diagnosis of an agent's failure on a GroupTravelPlanning constraint-satisfaction task matches the ground truth diagnosis.
