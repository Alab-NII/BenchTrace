...
LLM-as-judge for Q3 (Diagnosis) on BabyAI snapshots.
...
FINAL_DATASET_DIR = Path(__file__).resolve().parent.parent.parent / "final_dataset" / "babyai"

SYSTEM_PROMPT = """You are evaluating whether a model's diagnosis of an agent's failure on a BabyAI grid-world navigation task matches the ground truth diagnosis.
