...
Runs the Reflection Task evaluation for a given model on BabyAI snapshots.
...
ALL_GAMES = [f"level-{i}" for i in range(1, 21)]
...
def run(args):
    ...
    system_prompt = load_prompt("system_babyai.md")
